...
package com.justadeveloper96.pokedex.feature_pokemon_list.data.pokemon.repository.dao.mapper
...
fun PokemonDaoModel.toPokemon(): Pokemon {
    return Pokemon(
        id
    )
}

fun PokemonResponseModel.toPokemonDaoModel(): PokemonDaoModel {
